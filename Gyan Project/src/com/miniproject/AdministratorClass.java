	...
	public class AdministratorClass {
		...
		public void checkAdminRegistration(String emailID, String password) {
			...
			final String queryCheck = "SELECT * from administrator WHERE admin_emailId = '"+ emailID+"'and admin_password = '"+password+"'";
			try {
		...
		public void getCustomerDetails() {
			...
			try {
				...
				ResultSet rs = ps.executeQuery();
				System.out.println("---------------------------------------------------------------------------------------------");  
				System.out.printf("%5s %12s %12s %15s %18s", "CUSTOMER ID", "FIRST NAME", "LAST NAME", "MOBILE NO", "E-MAIL ID");  
				System.out.println();  
				System.out.println("---------------------------------------------------------------------------------------------");  
				while(rs.next()) {
					System.out.format("%7s %12s %14s %18s %25s", rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5));  
					System.out.println();  
		...
		public void getProductQuantityDetails() {
		...
		public void getCustomerHistoryDetails() {
