...
public class ProductDetailsClass {
	...
	public void insertProduct() throws SQLException {
		...
		try {
			...
			String product_desc = scanner.next();
			...
			pstatement = connection.prepareStatement(
					"insert into product (product_id,product_name,product_price,product_desc,product_quantity)values(?,?,?,?,?)");
			pstatement.setInt(1, product_id);
			pstatement.setString(2, product_name);
			pstatement.setString(3, product_price);
			pstatement.setString(4, product_desc);
			pstatement.setString(5, product_quantity);
	...
	public void showProductDetails() {
		...
		try {
			...
			System.out.println();
			AdministratorClass administration=new AdministratorClass();
			administration.selectAct();
			connection.close();
			ps.close();
			rs.close();
		} catch (Exception e) {
